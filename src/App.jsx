...
const productRankingDimensions = [
  {
    ...
    entries: [
      ...
      ["Mint List", "79", "+6%", "support score", "支持度"],
      ["TenThirty", "77", "+5%", "support score", "支持度"],
      ["Blue Whale", "75", "+5%", "support score", "支持度"],
      ["StudyEaseHaven", "73", "+4%", "support score", "支持度"],
      ["Open Canvas", "71", "+3%", "support score", "支持度"],
    ],
  },
  {
    id: "potential",
    ...
    entries: [
      ...
      ["Mint List", "+23%", "early signal", "week over week", "周环比"],
      ["Blue Whale", "+21%", "early signal", "week over week", "周环比"],
      ["First Hello", "+19%", "early signal", "week over week", "周环比"],
      ["Open Canvas", "+17%", "early signal", "week over week", "周环比"],
      ["Pebble Forms", "+15%", "early signal", "week over week", "周环比"],
    ],
  },
  {
    id: "revenue",
    ...
    entries: [
      ...
      ["Mint List", "¥860", "+11%", "30-day growth", "近 30 天增长"],
      ["ORBII", "¥790", "+10%", "30-day growth", "近 30 天增长"],
      ["TenThirty", "¥720", "+9%", "30-day growth", "近 30 天增长"],
      ["BuyingWindow", "¥640", "+8%", "30-day growth", "近 30 天增长"],
      ["StudyEaseHaven", "¥580", "+7%", "30-day growth", "近 30 天增长"],
    ],
  },
  {
    id: "users",
    ...
    entries: [
      ...
      ["Mint List", "8.9k", "+16%", "monthly visits", "月访问量"],
      ["First Hello", "8.1k", "+15%", "monthly visits", "月访问量"],
      ["Blue Whale", "7.6k", "+14%", "monthly visits", "月访问量"],
      ["Chiplab", "6.8k", "+13%", "monthly visits", "月访问量"],
      ["Paper Critters", "6.2k", "+12%", "monthly visits", "月访问量"],
    ],
  },
];
